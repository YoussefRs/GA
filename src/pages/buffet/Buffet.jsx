...
import bg from "../../assets/buffet/bg.png";
import bg2 from "../../assets/buffet/bg2.png";
import food1 from "../../assets/buffet/food1.png";
import food2 from "../../assets/buffet/food2.png";
...
export default function Buffet() {
  return (
    <div className="fingerfood_container">
      <Hero bgImg={bg} title={"CATERING/BUFFET"} />
