...
function Navbar() {
  ...
  const [hideLangMenuSm, setHideLangMenuSm] = useState(true);
  ...
  const [toggleFoodDropmenuSm, setToggleFoodDropmenuSm] = useState(false);
    ...
    <div className={`${scrolled ? "wrap scrolled" : "wrap"} py-xl-0 py-3`}>
      <div className="nav_inner_container">
        <nav className="pullUp d-flex justify-content-between">
          ...
          <div className="sidebar_toggler_container">
            ...
            <Offcanvas.Body>
              <div className="d-flex flex-column justify-content-between h-100 ">
                <div className="links">
                  ...
                  <div
                    onClick={() => {
                      setToggleFoodDropmenuSm(!toggleFoodDropmenuSm);
                    }}
                    style={{ marginBottom: ".5rem", border: "none" }}
                  >
                    <span>{item3}</span>
                  </div>
                  <div
                    className={`food_dropmenu_sm ${
                      toggleFoodDropmenuSm ? "hide" : ""
                    }`}
                  ...
                  <div
                    className={`_sidebar_lang_toggler ${
                      hideLangMenu ? "hided" : ""
                    }`}
                  >
                    <div
